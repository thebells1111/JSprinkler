...
class Sprinkler {
  constructor() {
    this.manual = 0;
    this.stations = {
      s1: { name: "s1", pin: 11, status: 0, duration: 0 },
      s2: { name: "s2", pin: 13, status: 0, duration: 0 },
      s3: { name: "s3", pin: 15, status: 0, duration: 0 },
      s4: { name: "s4", pin: 29, status: 0, duration: 0 },
      s5: { name: "s5", pin: 31, status: 0, duration: 0 },
      s6: { name: "s6", pin: 33, status: 0, duration: 0 },
      s7: { name: "s7", pin: 36, status: 0, duration: 0 },
      s8: { name: "s8", pin: 37, status: 0, duration: 0 }
    };
    this.masterValve = {
      station: "s8",
      enable: 1
  ...
  checkPrograms() {
    ...
    this.programs.forEach(p => {
      ...
      //sets programs for next interval in current time is greater the stop time
